...
namespace JasonLib.Security
{
    public static class JlRsa
    {
        /// <summary>
        ...
        /// <param name="xmlKey">XML格式密匙</param>
        /// <returns>加密遇到错误将会返回原字符串</returns>
        public static string EncryptString(string source, string xmlKey)
        {
            try
            {
                ...
                PlainTextBArray = (new UnicodeEncoding()).GetBytes(source);
        ...
        public static string DecryptString(string encryptString, string xmlKey)
        {
            try
            {
                byte[] PlainTextBArray;
